...
- [Collections](#collections)
  - [Lists](#lists)
    ...
    - [Add a New Element at the End](#add-a-new-element-at-the-end)
    - [Inserting an Element at a Specific Position](#inserting-an-element-at-a-specific-position)
    - [Removing a Particular Element](#removing-a-particular-element)
    - [Removing with pop](#removing-with-pop)
    - [Clearing all Elements](#clearing-all-elements)
    - [Accessing Elements Using Indexing](#accessing-elements-using-indexing)
    - [Slicing](#slicing)
    - [Concatenation](#concatenation)
    - [Repetition](#repetition)
    - [Finding the First Occurrence of an Element](#finding-the-first-occurrence-of-an-element)
    - [Counting Element Occurrences](#counting-element-occurrences)
    - [Sorting Items in a List](#sorting-items-in-a-list)
    - [Sorting List in Place](#sorting-list-in-place)
    - [Reversing a List](#reversing-a-list)
    - [Copying a List](#copying-a-list)
    - [Length of List](#length-of-list)
    - [Minimum and Maximum of List](#minimum-and-maximum-of-list)
    - [Sum of List](#sum-of-list)
    - [Enumerating List](#enumerating-list)
    - [Checking if All/Any Elements are True](#checking-if-allany-elements-are-true)
    - [Special List Operations](#special-list-operations)
- [Strings](#strings)
  - [Creating a String](#creating-a-string)
  - [Accessing Characters Using Indexing](#accessing-characters-using-indexing)
  - [Slicing](#slicing-1)
  ...
  - [Split a String into a List of Each Character](#split-a-string-into-a-list-of-each-character)
- [Loops](#loops)
  - [For Loops](#for-loops)
  - [While Loops](#while-loops)
  - [Looping Over Collections](#looping-over-collections)
    - [List](#list)
    - [String](#string)
  - [Applications of Looping](#applications-of-looping)
  ...
  - [Conditional Looping](#conditional-looping)
    ...
    - [Use-case with a For Loop](#use-case-with-a-for-loop)
